...
Documentation on the usage of PythonNet in MOSAIC can be found in the [AIROB Wiki](https://gitlab.aibe.fau.de/airob/wiki/-/wikis/Code-&-Software/Feature:-PythonNet-in-imBlocks)
...
### Important Notes:
- Always ensure you specify the correct Python DLL path in your code or configuration files.
- Verify that the `.venv\Lib\site-packages` directory is referenced correctly in your C# project.
- In Python.NET, append this path in your code to the Python GIL setup:
  ```csharp
