...
Welcome to MOSAIC—the Modular, Open-Source Suite for Assistive Intelligent Control—developed at the [AIROB Lab](https://www.airob.tf.fau.de/) at FAU Erlangen-Nürnberg. MOSAIC  is an extensible, user-friendly software platform for real-time biosignal processing, device control, and rapid prototyping in assistive robotics and human-machine interfaces. <br>

MOSAIC is a modular software suite written in C# that allows you to build, test, and visualize complex signal processing and machine learning pipelines. The system is designed for research and prototyping in fields such as prosthesis control, orthotics, rehabilitation robotics, and beyond.
